...
from champions.services import FootballDataAPI, BATCH_DELAY


class Command(BaseCommand):
    help = 'Synchronize Champions League matches from football-data.org API'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'Starting Champions League match synchronization (batch_size={batch_size}, delay={delay}s)...')
        try:
            api = FootballDataAPI()
